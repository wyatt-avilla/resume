...
\begin{rSection}{Education}
	...
	\textit{Major:} M.S Software Engineering, specializing in Software Systems Engineering \hfill \\
...
\begin{rSection}{Technical Strengths}
	...
	\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
		Programming Languages & C/C++, Python (Pandas, NumPy), Rust, Shell, Nix, Lua   \\
		Software \& Tools     & Git, Linux, GitHub Actions, Docker, NixOS, WebAssembly \\
	\end{tabular}
