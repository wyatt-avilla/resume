...
\address{\href{mailto:wyatt@linux.com}{wyatt@linux.com}}
...
\begin{rSection}{Education}
  ...
  networking software
  \hfill{} \textbf{CGPA:\@ 4.0}
  \href{https://github.com/wyatt-avilla/resume/blob/main/assets/sjsu_unofficial_transcript.pdf}{Transcript
  \scaledfaExternalLink} \\
...
\item{} {\bf{}
  ...
  assembly into 3,200 lines of C code for reverse-engineering
  \textit{Super Smash Bros. Melee}. Ensured byte-perfect accuracy
  through GitHub Actions CI that validated the compiled binary
  against the original. Collaborated through code reviews with
